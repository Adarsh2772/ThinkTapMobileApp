...
const en: Dict = {
  ...
  appLanguageHint: 'Controls the app interface only. The final transcript auto-detects the language you spoke.',
  transcriptionLanguage: 'Spoken language',
  transcriptionLanguageHint:
    'Final transcript auto-detects the language you spoke. This picker is only for live on-device preview and spoken commands.',
  speechLocaleSaved: 'Live preview language updated. Final transcripts still auto-detect what you speak.',
  ...
  ideas: 'Tasset',
  search: 'Search',
  readyForIdea: 'Tap to capture your next thought asset (tasset).',
  recentIdeas: 'Recent Ideas',
  viewAll: 'View all',
  tapToRecord: 'Tap to Record',
  recording: 'Recording…',
  aiTranscribeHint: 'Auto-detects Indian languages and keeps the original script',
...
const hi: Dict = {
  ...
  profile: 'प्रोफ़ाइल',
  appLanguage: 'ऐप भाषा',
  appLanguageHint: 'केवल ऐप इंटरफ़ेस की भाषा। अंतिम ट्रांसक्रिप्ट बोली गई भाषा अपने आप पहचानती है।',
  transcriptionLanguage: 'Spoken language',
  transcriptionLanguageHint:
    'अंतिम ट्रांसक्रिप्ट बोली गई भाषा अपने आप पहचानती है। यह चयन केवल लाइव प्रीव्यू और वॉइस कमांड के लिए है।',
  speechLocaleSaved: 'लाइव प्रीव्यू भाषा अपडेट हुई। अंतिम ट्रांसक्रिप्ट फिर भी बोली गई भाषा पहचानती है।',
  ...
  ideas: 'Tasset',
  search: 'खोज',
  readyForIdea: 'अगले विचार के लिए तैयार?',
  recentIdeas: 'हाल के आइडिया',
  viewAll: 'सभी देखें',
  tapToRecord: 'रिकॉर्ड करने के लिए टैप करें',
  recording: 'रिकॉर्डिंग…',
  aiTranscribeHint: 'भारतीय भाषा अपने आप पहचानता है और मूल लिपि रखता है',
...
const mr: Dict = {
  ...
  appLanguageHint: 'फक्त अ‍ॅप इंटरफेसची भाषा. अंतिम ट्रान्सक्रिप्ट बोललेली भाषा आपोआप ओळखते.',
  transcriptionLanguage: 'Spoken language',
  transcriptionLanguageHint:
    'अंतिम ट्रान्सक्रिप्ट बोललेली भाषा आपोआप ओळखते. हा पर्याय फक्त लाइव्ह प्रीव्ह्यू आणि व्हॉइस कमांडसाठी आहे.',
  speechLocaleSaved: 'लाइव्ह प्रीव्ह्यू भाषा अपडेट झाली. अंतिम ट्रान्सक्रिप्ट तरीही बोललेली भाषा ओळखते.',
  ...
  ideas: 'Tasset',
  search: 'शोध',
  readyForIdea: 'पुढच्या विचारासाठी तयार?',
  recentIdeas: 'अलीकडील आयडिया',
  viewAll: 'सर्व पहा',
  tapToRecord: 'रेकॉर्ड करण्यासाठी टॅप करा',
  recording: 'रेकॉर्डिंग…',
  aiTranscribeHint: 'भारतीय भाषा आपोआप ओळखते आणि मूळ लिपी ठेवते',
...
const fr: Dict = {
  ...
  ideas: 'Tasset',
  search: 'Recherche',
  readyForIdea: 'Prêt pour votre prochaine pensée ?',
...
const es: Dict = {
  ...
  ideas: 'Tasset',
  search: 'Buscar',
  readyForIdea: '¿Listo para tu próximo pensamiento?',
...
const de: Dict = {
  ...
  ideas: 'Tasset',
  search: 'Suche',
  readyForIdea: 'Bereit für deinen nächsten Gedanken?',
...
const pt: Dict = {
  ...
  ideas: 'Tasset',
  search: 'Pesquisar',
  readyForIdea: 'Pronto para o próximo pensamento?',
